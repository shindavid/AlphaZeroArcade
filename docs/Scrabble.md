...
This offline process recognizes that certain letter combinations provide stronger bingo possibilities (e.g., -ING, -EST), that
a healthy ratio of vowels-vs-consonants is preferable, that a Q is better when accompanied by a U, etc.
