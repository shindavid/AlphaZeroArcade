...
/*
 * A variant of generic::beta0::Player that exports training data to a file via TrainingDataWriter.
 */
...
#include "inline/generic_players/beta0/DataExportingPlayer.inl"
