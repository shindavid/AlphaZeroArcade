...
class PlayerGeneratorBase : public core::AbstractPlayerGenerator<typename Traits::Game> {
 public:
  ...
  using BasePlayer = generic::beta0::Player<Traits>;
  ...
  static_assert(std::is_base_of_v<BasePlayer, PlayerT>,
                "PlayerT must be derived from generic::beta0::Player<Traits>");
...
class PlayerSubfactory<generic::beta0::CompetitionPlayerGenerator<Traits>>
    : public generic::beta0::Subfactory<generic::beta0::CompetitionPlayerGenerator<Traits>> {};

template <search::concepts::Traits Traits>
class PlayerSubfactory<generic::beta0::TrainingPlayerGenerator<Traits>>
    : public generic::beta0::Subfactory<generic::beta0::TrainingPlayerGenerator<Traits>> {};

}  // namespace core

#include "inline/generic_players/beta0/PlayerGenerator.inl"
