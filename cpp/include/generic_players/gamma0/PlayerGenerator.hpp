...
class PlayerGeneratorBase : public core::AbstractPlayerGenerator<typename Traits::Game> {
 public:
  ...
  using BasePlayer = generic::gamma0::Player<Traits>;
  ...
  static_assert(std::is_base_of_v<BasePlayer, PlayerT>,
                "PlayerT must be derived from generic::gamma0::Player<Traits>");
...
using CompetitionPlayerGenerator = PlayerGeneratorBase<Traits, generic::gamma0::Player<Traits>>;

template <search::concepts::Traits Traits>
using TrainingPlayerGeneratorBase =
  PlayerGeneratorBase<Traits, generic::DataExportingPlayer<generic::gamma0::Player<Traits>>,
                      search::kTraining>;
...
template <search::concepts::Traits Traits>
class PlayerSubfactory<generic::gamma0::CompetitionPlayerGenerator<Traits>>
    : public generic::gamma0::Subfactory<generic::gamma0::CompetitionPlayerGenerator<Traits>> {};

template <search::concepts::Traits Traits>
class PlayerSubfactory<generic::gamma0::TrainingPlayerGenerator<Traits>>
    : public generic::gamma0::Subfactory<generic::gamma0::TrainingPlayerGenerator<Traits>> {};

}  // namespace core

#include "inline/generic_players/gamma0/PlayerGenerator.inl"
