...
struct NodeStableData : public alpha0::NodeStableData<Spec> {
  ...
  // Per-node static latent z_s, consumed by BackupNNEvaluator::apply(). Populated from the
  // static_latent network head at node-evaluation time.
  ...
  // weight-dependent state (R, U, static_latent, edge P/AV/AU/action_latent, edge e_cached,
