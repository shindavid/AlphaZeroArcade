...
template <class GR>
concept GameResults =
  requires(const typename GR::Tensor& const_tensor_ref, typename GR::Tensor& tensor_ref) {
    ...
    /*
     * The tensor representation of the game result. This is what the game rules outputs, and what
     * the value-head of the neural network aims to learn.
     *
