...
concept GameIO = requires(
  ...
  { GI::print_state(base_state, core::action_t{}, player_name_array_ptr) };
  { GI::print_state(base_state, core::action_t{}) };
  { GI::print_state(base_state) };
  { GI::print_mcts_results(policy_tensor, search_results) };
};
