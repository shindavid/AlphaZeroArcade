 ...
 *
 * For now, beta0::ManagerParams is identical to alpha0::ManagerParams. Later we will specialize it.
 * For instance, we expect that beta0 won't need Dirichlet noise.
 */
...
#include "inline/betazero/ManagerParams.inl"
