...
using ActionMask = typename GameStateTypes::ActionMask;
  ...
  virtual size_t serialize_action(char* buf, size_t buf_size, const Action& action) const = 0;
  virtual void deserialize_action(const char* buf, Action* action) const = 0;
