...
inline LcZeroInputFrame::LcZeroInputFrame(const GameState& state) {
...
inline GameState LcZeroInputFrame::to_state_unsafe() const {
...
inline chess::Bitboard LcZeroInputFrame::get(chess::PieceType piece_type,
...
inline chess::Bitboard LcZeroInputFrame::get(chess::PieceType piece_type) const {
  // clang-format off
  switch (piece_type.internal()) {
...
inline chess::Bitboard LcZeroInputFrame::getPawns() const { return pawns & kPawnsMask; }

inline chess::Bitboard LcZeroInputFrame::getKnights() const {
...
inline chess::Bitboard LcZeroInputFrame::getBishops() const {
  return diagonal_movers & ~orthogonal_movers;
}

inline chess::Bitboard LcZeroInputFrame::getRooks() const { return orthogonal_movers & ~diagonal_movers; }

inline chess::Bitboard LcZeroInputFrame::getQueens() const { return orthogonal_movers & diagonal_movers; }

inline chess::Bitboard LcZeroInputFrame::getKings() const { return getKings(kWhite) | getKings(kBlack); }

inline chess::Bitboard LcZeroInputFrame::getPawns(core::seat_index_t player) const {
  return getPawns() & all_pieces[player];
}

inline chess::Bitboard LcZeroInputFrame::getKnights(core::seat_index_t player) const {
...
inline chess::Bitboard LcZeroInputFrame::getBishops(core::seat_index_t player) const {
  return getBishops() & all_pieces[player];
}

inline chess::Bitboard LcZeroInputFrame::getRooks(core::seat_index_t player) const {
  return getRooks() & all_pieces[player];
}

inline chess::Bitboard LcZeroInputFrame::getQueens(core::seat_index_t player) const {
  return getQueens() & all_pieces[player];
}

inline chess::Bitboard LcZeroInputFrame::getKings(core::seat_index_t player) const {
  return chess::Bitboard::fromSquare(chess::Square(static_cast<int>(kings[player])));
}

inline void LcZeroInputFrame::fill_board(GameState& state) const {
...
inline void LcZeroInputFrame::fill_board(GameState& state, core::seat_index_t player,
