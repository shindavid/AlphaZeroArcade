...
template <search::concepts::SearchSpec SearchSpec>
void Algorithms<SearchSpec>::init_root_edges(GeneralContext& general_context) {}
...
void Algorithms<SearchSpec>::write_to_training_info(const TrainingInfoParams& params,
  ...
  if (use_for_training) {
    training_info.action_values_target =
      x0::Algorithms<SearchSpec>::apply_mask(mcts_results->AQ, mcts_results->pre_expanded_moves);
  ...
  if (use_for_training) {
    training_info.AQ_min = x0::Algorithms<SearchSpec>::apply_mask(mcts_results->AQ_min,
                                                                  mcts_results->pre_expanded_moves);
    training_info.AQ_max = x0::Algorithms<SearchSpec>::apply_mask(mcts_results->AQ_max,
                                                                  mcts_results->pre_expanded_moves);
    training_info.AU =
      x0::Algorithms<SearchSpec>::apply_mask(mcts_results->AU, mcts_results->pre_expanded_moves);
  }
}
...
void Algorithms<SearchSpec>::to_record(const TrainingInfo& training_info,
  ...
  alpha0::Algorithms<SearchSpec>::to_record(training_info, full_record);
