// Forked from cpp/inline/alpha0/DataExportingPlayer.inl
// Changes: alpha0 -> beta0 namespaces; InfoSet used instead of State; beta0 GameLog types

#include "beta0/DataExportingPlayer.hpp"
