...
inline boost::filesystem::path get_engine_plan_cache_path(
  ...
  uint64_t workspace_size_in_bytes, int batch_size, int version) {
  return std::format(
    "/workspace/mount/TensorRT-cache/v{}/sm_{}/trt_{}/fp_{}/ws_{}/batch_{}/{}-v{}.engine",
    kCacheVersion, cuda_util::get_sm_tag(), get_version_tag(), precision_to_string(precision),
    workspace_size_in_bytes, batch_size, model_architecture_signature, version);
}
