...
template <core::concepts::Game Game>
inline void HumanTuiPlayer<Game>::receive_state_change(core::seat_index_t, const BaseState&,
...
template <core::concepts::Game Game>
inline void HumanTuiPlayer<Game>::end_game(const BaseState& state, const ValueArray& outcome) {
  util::ScreenClearer::clear_once();
...
template <core::concepts::Game Game>
inline void HumanTuiPlayer<Game>::print_state(const BaseState& state, bool terminal) {
