...
template <core::GameStateConcept GameState, core::TensorizorConcept<GameState> Tensorizor>
void TreeData<GameState, Tensorizor>::increment_active_thread_count() {
  std::unique_lock lock(search_mutex_);
  active_thread_count_++;
}

template <core::GameStateConcept GameState, core::TensorizorConcept<GameState> Tensorizor>
void TreeData<GameState, Tensorizor>::decrement_active_thread_count() {
  std::unique_lock lock(search_mutex_);
  active_thread_count_--;
...
template <core::GameStateConcept GameState, core::TensorizorConcept<GameState> Tensorizor>
void TreeData<GameState, Tensorizor>::wait_for_search_completion() {
  std::unique_lock lock(search_mutex_);
...
typename TreeData<GameState, Tensorizor>::edge_t* TreeData<GameState, Tensorizor>::wait_for_edge(
    Node* root, Node* node, core::action_index_t action_index, int root_prefetch_count_limit) {
...
template <core::GameStateConcept GameState, core::TensorizorConcept<GameState> Tensorizor>
void TreeData<GameState, Tensorizor>::reset_prefetch_threads() {
