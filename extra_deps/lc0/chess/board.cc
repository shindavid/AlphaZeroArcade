...
void ChessBoard::flip_vertical() {
  bool black_to_move  = flipped_;
  if (black_to_move) {
    Mirror();
  }
  our_pieces_.flip_vertical();
  their_pieces_.flip_vertical();
  rooks_.flip_vertical();
  bishops_.flip_vertical();
  pawns_.flip_vertical();
  our_king_.flip_vertical();
  their_king_.flip_vertical();
...
void ChessBoard::mirror_horizontal() {
  bool black_to_move = flipped_;
  if (black_to_move) {
    Mirror();
  }
  our_pieces_.mirror_horizontal();
  their_pieces_.mirror_horizontal();
  rooks_.mirror_horizontal();
  bishops_.mirror_horizontal();
  pawns_.mirror_horizontal();
  our_king_.mirror_horizontal();
  their_king_.mirror_horizontal();

  if (black_to_move) {
    Mirror();
  }
}
void ChessBoard::flip_main_diag() {
  bool black_to_move = flipped_;
  if (black_to_move) {
    Mirror();
  }
  our_pieces_.flip_main_diag();
  their_pieces_.flip_main_diag();
  rooks_.flip_main_diag();
  bishops_.flip_main_diag();
  pawns_.flip_main_diag();
  our_king_.flip_main_diag();
  their_king_.flip_main_diag();

  if (black_to_move) {
    Mirror();
  }
}
void ChessBoard::flip_anti_diag() {
  bool black_to_move = flipped_;
  if (black_to_move) {
    Mirror();
  }
  our_pieces_.flip_anti_diag();
  their_pieces_.flip_anti_diag();
  rooks_.flip_anti_diag();
  bishops_.flip_anti_diag();
  pawns_.flip_anti_diag();
  our_king_.flip_anti_diag();
  their_king_.flip_anti_diag();

  if (black_to_move) {
    Mirror();
  }
}
void ChessBoard::rot90_clockwise() {
  bool black_to_move = flipped_;
  if (black_to_move) {
    Mirror();
  }
  our_pieces_.rot90_clockwise();
  their_pieces_.rot90_clockwise();
  rooks_.rot90_clockwise();
  bishops_.rot90_clockwise();
  pawns_.rot90_clockwise();
  our_king_.rot90_clockwise();
  their_king_.rot90_clockwise();

  if (black_to_move) {
    Mirror();
  }
}
void ChessBoard::rot180() {
  bool black_to_move = flipped_;
  if (black_to_move) {
    Mirror();
  }
  our_pieces_.rot180();
  their_pieces_.rot180();
  rooks_.rot180();
  bishops_.rot180();
  pawns_.rot180();
  our_king_.rot180();
...
void ChessBoard::rot270_clockwise() {
  bool black_to_move = flipped_;
  if (black_to_move) {
    Mirror();
  }
  our_pieces_.rot270_clockwise();
  their_pieces_.rot270_clockwise();
  rooks_.rot270_clockwise();
  bishops_.rot270_clockwise();
  pawns_.rot270_clockwise();
  our_king_.rot270_clockwise();
  their_king_.rot270_clockwise();
