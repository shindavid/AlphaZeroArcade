...
class EvalManager(GamingManagerBase):
    ...
    def _gen_match_request_data(self, test_iagent: IndexedAgent, next_opponent_iagent: IndexedAgent, next_n_games) -> JsonDict:
        ...
        use_stored_binary = self._controller.build_params.use_stored_binary

        eval_binary_src = self._controller._get_binary_path(use_stored_binary=use_stored_binary,
                                                            stored_binary_path=self._controller.organizer_binary_path)

        benchmark_binary_src = self._controller._get_binary_path(use_stored_binary=use_stored_binary,
